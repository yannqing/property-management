...
public class CostTypeController {
    ...
    @DeleteMapping("/{id}")
    @Parameters(@Parameter(name = "id", description = "费用类型 id", required = true, in = ParameterIn.PATH))
    ...
    @DeleteMapping("/batch")
    @Parameters(@Parameter(name = "costTypeIds", description = "费用类型 id 数组", required = true))
