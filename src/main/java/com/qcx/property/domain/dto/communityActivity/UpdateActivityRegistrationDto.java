...
/**
 * @description: 更新活动报名 dto
 * @author: yannqing
 * @create: 2025-02-08 17:44
 * @from: <更多资料：yannqing.com>
 **/
@Data
@Schema(name = "UpdateActivityRegistrationDto", description = "修改活动报名对象")
public class UpdateActivityRegistrationDto {
    /**
     * 主键ID
     */
    ...
    public static ActivityRegistration objToActivityRegistration(UpdateActivityRegistrationDto updateActivityRegistrationDto) {
        if (updateActivityRegistrationDto == null) {
            return null;
        }

        ActivityRegistration activityRegistration = new ActivityRegistration();
        BeanUtils.copyProperties(updateActivityRegistrationDto, activityRegistration);
